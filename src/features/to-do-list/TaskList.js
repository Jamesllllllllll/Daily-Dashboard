              ...
              <ListItem key={taskObj.taskTitle + index} listid={index} sx={{}}>
                ...
                >
                  ...
                  <TaskListItem
                    ...
                    sx={{
                      backgroundColor:
                        completedStepCounter(taskObj.taskSteps) ===
                        taskObj.taskSteps.length
                          ? 'rgba(0, 255, 0, .25)'
                          : '#fff',
                    }}
                  ...
                  >
                    ...
                    >{`Completed ${completedStepCounter(
                      taskObj.taskSteps
                    )} of ${taskObj.taskSteps.length} steps.`}</Typography>
                  </TaskListItem>
                </Stack>
              </ListItem>
            ))}

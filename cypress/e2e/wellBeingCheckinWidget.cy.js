...
describe("User Journey", () => {
  ...
  it("it saves corresponding energy level when dragging slider", () => {
    ...
    // Changing the range value to 0
    //wellBeingCheckinWidget.getEnergySlider().as('range').invoke('val', 0).click('left');
    wellBeingCheckinWidget.getEnergy().should('have.text', '0');
